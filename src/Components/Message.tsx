import { Flex, Card, CardBody, Button, SlideFade } from '@chakra-ui/react';
  ...
  return (
    ...
    >
      <Card
        w="fit-content"
        maxWidth="75%"
        bg={from === 'me' ? 'brand.main' : 'gray.500'}
      >
        <CardBody>{message}</CardBody>
      </Card>
      <SlideFade in={HoverMessage} offsetY="20px">
        {HoverMessage && (
          <>
            <Button bg="whiteAlpha.600">
              <svg
